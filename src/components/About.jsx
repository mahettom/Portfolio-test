...
const ServiceCard = ({ index, title, icon }) => {
  ...
  return (
    <>
      <div className={`${styles.sectionSubText} text-center flex-none bg-tertiary rounded-tr-3xl rounded-bl-3xl p-2 h-52 w-80 md:h-64 md:w-72`}>
        <h3 className=' pt-[30%] text-white text-[20px] font-bold'>{title}</h3>
      </div>
    </>
  )
}
...
const About = () => {
  ...
  return (
    <>
      ...
      <div className='absolute top-[420px] left-10 flex flex-row gap-4 overflow-x-auto w-full xs:top-[500px] md:top-96 md:left-32 lg:top-96 lg:left-36 '>
      ...
      <div className="md:hidden lg:hidden xl:hidden absolute bottom-[-4rem] xs:right-8 sm:right-16 w-full flex justify-center items-center">
